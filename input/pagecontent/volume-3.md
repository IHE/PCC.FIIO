...
For a valid example of the HL7 FHIR IPS Bundle review the [Pandemic IPS Example Patient Patricia Jordana Bundle](input/fsh/examples/ex-Bundle-secondaryUse-pandemnicIPS-Patricia-Jordana.fsh.html). This example patient Has entries for all deffined entries in the FHIR IPS bundle, including additional content that supports the ODH Option. 
