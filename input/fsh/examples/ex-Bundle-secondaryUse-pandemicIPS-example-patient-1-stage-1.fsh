Instance: ex-Bundle-pandemicIPS-example-patient-1-stage-1
...
* entry[+].fullUrl = "http://example.org/Composition/ex-Composition-pandemicIPS-stage-1"
* entry[=].resource = ex-Composition-pandemicIPS-stage-1
* entry[=].id = "ex-Composition-pandemicIPS-stage-1"
* entry[+].fullUrl = "http://example.org/Patient/ex-Patient-pandemicIPS-stage-1"
* entry[=].resource = ex-Patient-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Organization/ex-Organization-pandemicIPS-stage-1"
* entry[=].resource = ex-Organization-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-1"
* entry[=].resource = ex-Practitioner-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-1"
* entry[=].resource = ex-Practitioner2-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/MedicationStatement/ex-MedicationStatement-pandemicIPS-stage-1"
* entry[=].resource = ex-MedicationStatement-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition1-pandemicIPS-stage-1"
* entry[=].resource = ex-Condition1-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition2-pandemicIPS-stage-1"
* entry[=].resource = ex-Condition2-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition3-pandemicIPS-stage-1"
* entry[=].resource = ex-Condition3-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Procedure/ex-Procedure-pandemicIPS-stage-1"
* entry[=].resource = ex-Procedure-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/AllergyIntolerance/ex-Allergy-pandemicIPS-stage-1"
* entry[=].resource = ex-Allergy-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-Lab-pandemicIPS-stage-1"
* entry[=].resource = ex-Lab-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Immunization/ex-Immunization-pandemicIPS-stage-1"
* entry[=].resource = ex-Immunization-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-PastPresJob-pandemicIPS-stage-1"
* entry[=].resource = ex-PastPresJob-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-PregStat-pandemicIPS-stage-1"
* entry[=].resource = ex-PregStat-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-EDD-pandemicIPS-stage-1"
* entry[=].resource = ex-EDD-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/DeviceUseStatement/ex-DeviceUse-pandemicIPS-stage-1"
* entry[=].resource = ex-DeviceUse-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Device/ex-Device-pandemicIPS-stage-1"
* entry[=].resource = ex-Device-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/CarePlan/ex-CarePlan-pandemicIPS-stage-1"
* entry[=].resource = ex-CarePlan-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Flag/ex-Alert-pandemicIPS-stage-1"
* entry[=].resource = ex-Alert-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/ClinicalImpression/ex-ClinicalImp-pandemicIPS-stage-1"
* entry[=].resource = ex-ClinicalImp-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSignsPanel-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSignsPanel-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-Height-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSigns-Height-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-Weight-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSigns-Weight-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-BMI-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSigns-BMI-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-BP-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSigns-BP-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-HeartRate-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSigns-HeartRate-pandemicIPS-stage-1
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-1"
* entry[=].resource = ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-1

Instance: ex-Composition-pandemicIPS-stage-1
InstanceOf: CompositionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Composition-uv-ips"
* id = "ex-Composition-pandemicIPS-stage-1"
* status = #final
* type = $loinc#60591-5
* subject = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-1)
* date = "2024-07-01T00:00:00Z"
* author = Reference(http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-1)
* title = "International Patient Summary"
* confidentiality = #N
* custodian = Reference(http://example.org/Organization/ex-Organization-pandemicIPS-stage-1)
...
* section[sectionMedications].entry[+] = Reference(http://example.org/MedicationStatement/ex-MedicationStatement-pandemicIPS-stage-1)
...
* section[sectionAllergies].entry[+] = Reference(http://example.org/AllergyIntolerance/ex-Allergy-pandemicIPS-stage-1)
...
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition1-pandemicIPS-stage-1)
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition2-pandemicIPS-stage-1)
...
* section[sectionPastProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition3-pandemicIPS-stage-1)
...
* section[sectionImmunizations].entry[+] = Reference(http://example.org/Immunization/ex-Immunization-pandemicIPS-stage-1)
...
* section[sectionProceduresHx].entry[+] = Reference(http://example.org/Procedure/ex-Procedure-pandemicIPS-stage-1)
...
* section[sectionResults].entry[+] = Reference(http://example.org/Observation/ex-Lab-pandemicIPS-stage-1)
...
* section[sectionSocialHistory].entry[+] = Reference(http://example.org/Observation/ex-PastPresJob-pandemicIPS-stage-1)
...
* section[sectionPregnancyHx].entry[+] = Reference(http://example.org/Observation/ex-PregStat-pandemicIPS-stage-1)
...
* section[sectionMedicalDevices].entry[+] = Reference(http://example.org/DeviceUseStatement/ex-DeviceUse-pandemicIPS-stage-1)
...
* section[sectionVitalSigns].entry[+] = Reference(http://example.org/Observation/ex-VitalSignsPanel-pandemicIPS-stage-1)
...
* section[sectionPlanOfCare].entry[+] = Reference(http://example.org/CarePlan/ex-CarePlan-pandemicIPS-stage-1)
...
* section[sectionAlerts].entry[+] = Reference(http://example.org/Flag/ex-Alert-pandemicIPS-stage-1)
...
* section[sectionFunctionalStatus].entry[+] = Reference(http://example.org/ClinicalImpression/ex-ClinicalImp-pandemicIPS-stage-1)


Instance: ex-Organization-pandemicIPS-stage-1
InstanceOf: OrganizationUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Organization-uv-ips"
* id = "ex-Organization-pandemicIPS-stage-1"
...
Instance: ex-Patient-pandemicIPS-stage-1
...
"""
Usage: #example
* id = "ex-Patient-pandemicIPS-stage-1"
...
* generalPractitioner = Reference(http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-1) "Yaser, Joseph"
...
Instance: ex-Practitioner2-pandemicIPS-stage-1
InstanceOf: PractitionerUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Practitioner-uv-ips"
* id = "ex-Practitioner2-pandemicIPS-stage-1"
* name.text = "Joseph Yaser"
* name.family = "Joseph"
* name.given = "Yaser"

Instance: ex-MedicationStatement-pandemicIPS-stage-1
InstanceOf: MedicationStatementIPS
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationStatement-uv-ips"
* id = "ex-MedicationStatement-pandemicIPS-stage-1"
* status = #completed
...
* asserter = Reference(http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-1)

Instance: ex-Condition2-pandemicIPS-stage-1
InstanceOf: ConditionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Condition-uv-ips"
* id = "ex-Condition2-pandemicIPS-stage-1"
* clinicalStatus = $condition-clinical#active
* verificationStatus = $condition-ver-status#confirmed
* category = $condition-category#problem-list-item "Problem List Item"
* severity = $sct#24484000 "Severe"
...
Instance: ex-Condition3-pandemicIPS-stage-1
InstanceOf: ConditionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Condition-uv-ips"
* id = "ex-Condition3-pandemicIPS-stage-1"    
...
* patient = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-1)
* onsetDateTime = "2020-10-01"
* lastOccurrence = "2020-10-01"
* reaction.manifestation = $sct#271807003 "Rash"
* reaction.severity = #moderate

Instance: ex-Lab-pandemicIPS-stage-1
...
Instance: ex-PregStat-pandemicIPS-stage-1
...
* id = "ex-PregStat-pandemicIPS-stage-1"
* status = #final
...
* hasMember = Reference(http://example.org/Observation/ex-EDD-pandemicIPS-stage-1)

Instance: ex-EDD-pandemicIPS-stage-1
...
* performer = Reference(http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-Height-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-Weight-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-BMI-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-BP-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-HeartRate-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-1)

Instance: ex-VitalSigns-Height-pandemicIPS-stage-1
InstanceOf: vitalsigns
Usage: #inline
* id = "ex-VitalSigns-Height-pandemicIPS-stage-1"
* status = #final
* code = $loinc#8302-2 "Body height"
* subject = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-1)
* effectiveDateTime = "2024-06-15T09:44:00+06:00"
* performer = Reference(http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-1)
* valueQuantity = 71 '[in_i]' "in_i"

Instance: ex-VitalSigns-Weight-pandemicIPS-stage-1
InstanceOf: vitalsigns
Usage: #inline
* id = "ex-VitalSigns-Weight-pandemicIPS-stage-1"
* status = #final
...
Instance: ex-VitalSigns-BMI-pandemicIPS-stage-1
InstanceOf: vitalsigns
Usage: #inline
* id = "ex-VitalSigns-BMI-pandemicIPS-stage-1"
* status = #final
...
Instance: ex-VitalSigns-BP-pandemicIPS-stage-1
InstanceOf: vitalsigns
Usage: #inline
* id = "ex-VitalSigns-BP-pandemicIPS-stage-1"
* status = #final
...
Instance: ex-VitalSigns-HeartRate-pandemicIPS-stage-1
InstanceOf: vitalsigns
Usage: #inline
* id = "ex-VitalSigns-HeartRate-pandemicIPS-stage-1"  
* status = #final
...
Instance: ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-1
InstanceOf: vitalsigns
Usage: #inline
* id = "ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-1"
* status = #final
...
Instance: ex-CarePlan-pandemicIPS-stage-1
InstanceOf: CarePlan
Usage: #inline
* id = "ex-CarePlan-pandemicIPS-stage-1"
* status = #completed
* intent = #order
* title = "Plan of Care"
* subject = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-1)
...
Instance: ex-Alert-pandemicIPS-stage-1
...
* id = "ex-Alert-pandemicIPS-stage-1"
...
Instance: ex-ClinicalImp-pandemicIPS-stage-1
InstanceOf: ClinicalImpression
Usage: #inline
* id = "ex-ClinicalImp-pandemicIPS-stage-1"
* status = #completed
* code = $sct#105721009 "General problem AND/OR complaint (finding)"
* subject = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-1)
* effectiveDateTime = "2024-06-16"
* date = "2024-06-16"
* assessor = Reference(http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-1)
