...
* entry[+].fullUrl = "http://example.org/Practitioner/ex-Practitioner-IPS-SimoneHeps-stage-1"
* entry[=].resource = ex-Practitioner-IPS-SimoneHeps-stage-1
...
* status = #final
* type = $loinc#60591-5
* subject = Reference(http://example.org/Patient/ex-Patient-secondaryUse-pandemicIPS-stage-1)
* date = "2024-07-01T00:00:00Z"
* author = Reference(http://example.org/Practitioner/ex-Practitioner-IPS-SimoneHeps-stage-1)
* title = "International Patient Summary"
* confidentiality = #N
* custodian = Reference(http://example.org/Organization/ex-Organization-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionMedications].entry[+] = Reference(http://example.org/MedicationStatement/ex-MedicationStatement-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionAllergies].entry[+] = Reference(http://example.org/AllergyIntolerance/ex-Allergy-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition1-secondaryUse-pandemicIPS-stage-1)
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition2-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionPastProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition3-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionImmunizations].entry[+] = Reference(http://example.org/Immunization/ex-Immunization-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionProceduresHx].entry[+] = Reference(http://example.org/Procedure/ex-Procedure-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionResults].entry[+] = Reference(http://example.org/Observation/ex-Lab-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionSocialHistory].entry[+] = Reference(http://example.org/Observation/ex-PastPresJob-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionPregnancyHx].entry[+] = Reference(http://example.org/Observation/ex-PregStat-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionMedicalDevices].entry[+] = Reference(http://example.org/DeviceUseStatement/ex-DeviceUse-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionVitalSigns].entry[+] = Reference(http://example.org/Observation/ex-VitalSignsPanel-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionPlanOfCare].entry[+] = Reference(http://example.org/CarePlan/ex-CarePlan-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionAlerts].entry[+] = Reference(http://example.org/Flag/ex-Alert-secondaryUse-pandemicIPS-stage-1)
...
* section[sectionFunctionalStatus].entry[+] = Reference(http://example.org/ClinicalImpression/ex-ClinicalImp-secondaryUse-pandemicIPS-stage-1)
...
* generalPractitioner = Reference(http://example.org/Practitioner/ex-Practitioner-IPS-SimoneHeps-stage-1) "Heps, Simone"
...
* asserter = Reference(http://example.org/Practitioner/ex-Practitioner2-secondaryUse-pandemicIPS-stage-1)
...
* patient = Reference(http://example.org/Patient/ex-Patient-secondaryUse-pandemicIPS-stage-1)
...
* performer = Reference(http://example.org/Practitioner/ex-Practitioner-IPS-SimoneHeps-stage-1)
...
* performer.actor = Reference(http://example.org/Practitioner/ex-Practitioner2-secondaryUse-pandemicIPS-stage-1)
...
* hasMember = Reference(http://example.org/Observation/ex-EDD-secondaryUse-pandemicIPS-stage-1)
...
* device = Reference(http://example.org/Device/ex-Device-secondaryUse-pandemicIPS-stage-1)
...
* performer = Reference(http://example.org/Practitioner/ex-Practitioner-IPS-SimoneHeps-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-Height-secondaryUse-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-Weight-secondaryUse-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-BMI-secondaryUse-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-BP-secondaryUse-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-HeartRate-secondaryUse-pandemicIPS-stage-1)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-OxygenSaturation-secondaryUse-pandemicIPS-stage-1)
...
* subject = Reference(http://example.org/Patient/ex-Patient-secondaryUse-pandemicIPS-stage-1)
* effectiveDateTime = "2024-06-15T09:44:00+06:00"
* performer = Reference(http://example.org/Practitioner/ex-Practitioner2-secondaryUse-pandemicIPS-stage-1)
...
* effectiveDateTime = "2024-06-16"
* date = "2024-06-16"
* assessor = Reference(http://example.org/Practitioner/ex-Practitioner-IPS-SimoneHeps-stage-1)
