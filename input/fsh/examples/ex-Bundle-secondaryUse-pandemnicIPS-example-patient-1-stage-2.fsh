Instance: ex-Bundle-pandemicIPS-example-patient-1-stage-2
...
* entry[+].fullUrl = "http://example.org/Composition/ex-Composition-pandemicIPS-stage-2"
* entry[=].resource = ex-Composition-pandemicIPS-stage-2
* entry[=].id = "ex-Composition-pandemicIPS-stage-2"
* entry[+].fullUrl = "http://example.org/Patient/ex-Patient-pandemicIPS-stage-2"
* entry[=].resource = ex-Patient-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Organization/ex-OrganizationUvIps-pandemicIPS-stage-2"
* entry[=].resource = ex-OrganizationUvIps-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/MedicationStatement/ex-MedicationStatement-pandemicIPS-stage-2"
* entry[=].resource = ex-MedicationStatement-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition1-pandemicIPS-stage-2"
* entry[=].resource = ex-Condition1-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition2-pandemicIPS-stage-2"
* entry[=].resource = ex-Condition2-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Procedure/ex-Procedure-pandemicIPS-stage-2"
* entry[=].resource = ex-Procedure-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/AllergyIntolerance/ex-Allergy-pandemicIPS-stage-2"
* entry[=].resource = ex-Allergy-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Observation/ex-Lab-pandemicIPS-stage-2"
* entry[=].resource = ex-Lab-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Immunization/ex-Immunization-pandemicIPS-stage-2"
* entry[=].resource = ex-Immunization-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Observation/ex-PastPresJob-pandemicIPS-stage-2"
* entry[=].resource = ex-PastPresJob-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Observation/ex-PregStat-pandemicIPS-stage-2"
* entry[=].resource = ex-PregStat-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Observation/ex-EDD-pandemicIPS-stage-2"
* entry[=].resource = ex-EDD-pandemicIPS-stage-2
* entry[+].fullUrl = "http://example.org/Flag/ex-Alert-pandemicIPS-stage-2"
* entry[=].resource = ex-Alert-pandemicIPS-stage-2


Instance: ex-Composition-pandemicIPS-stage-2
InstanceOf: CompositionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Composition-uv-ips"
* id = "ex-Composition-pandemicIPS-stage-2"
* status = #final
* type = $loinc#60591-5
* subject = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-2)
* date = "2024-10-16T00:00:00Z"
* author = Reference(http://example.org/Organization/ex-OrganizationUvIps-pandemicIPS-stage-2)
* title = "International Patient Summary"
* confidentiality = #N
* custodian = Reference(http://example.org/Organization/ex-OrganizationUvIps-pandemicIPS-stage-2)
...
* section[sectionMedications].entry[+] = Reference(http://example.org/MedicationStatement/ex-MedicationStatement-pandemicIPS-stage-2)
...
* section[sectionAllergies].entry[+] = Reference(http://example.org/AllergyIntolerance/ex-Allergy-pandemicIPS-stage-2)
...
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition1-pandemicIPS-stage-2)
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition2-pandemicIPS-stage-2)
...
* section[sectionImmunizations].entry[+] = Reference(http://example.org/Immunization/ex-Immunization-pandemicIPS-stage-2)
...
* section[sectionProceduresHx].entry[+] = Reference(http://example.org/Procedure/ex-Procedure-pandemicIPS-stage-2)
...
* section[sectionResults].entry[+] = Reference(http://example.org/Observation/ex-Lab-pandemicIPS-stage-2)
...
* section[sectionSocialHistory].entry[+] = Reference(http://example.org/Observation/ex-PastPresJob-pandemicIPS-stage-2)
...
* section[sectionPregnancyHx].entry[+] = Reference(http://example.org/Observation/ex-PregStat-pandemicIPS-stage-2)
...
* section[sectionAlerts].entry[+] = Reference(http://example.org/Flag/ex-Alert-pandemicIPS-stage-2)
...
Instance: ex-Patient-pandemicIPS-stage-2
...
"""
Usage: #example
* id = "ex-Patient-pandemicIPS-stage-2"
...
Instance: ex-Condition2-pandemicIPS-stage-2
InstanceOf: ConditionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Condition-uv-ips"
* id = "ex-Condition2-pandemicIPS-stage-2"
* clinicalStatus = $condition-clinical#active
* verificationStatus = $condition-ver-status#confirmed
* category = $condition-category#problem-list-item "Problem List Item"
* severity = $sct#24484000 "Severe"
...
* patient = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-2)
* onsetDateTime = "2020-10-01"
* lastOccurrence = "2020-10-01"
* reaction.manifestation = $sct#271807003 "Rash"
* reaction.severity = #moderate

Instance: ex-Lab-pandemicIPS-stage-2
...
Instance: ex-PregStat-pandemicIPS-stage-2
...
* id = "ex-PregStat-pandemicIPS-stage-2"
* status = #final
...
* hasMember = Reference(http://example.org/Observation/ex-EDD-pandemicIPS-stage-2)

Instance: ex-EDD-pandemicIPS-stage-2
...
Instance: ex-Alert-pandemicIPS-stage-2
...
* id = "ex-Alert-pandemicIPS-stage-2"
* status = #active
