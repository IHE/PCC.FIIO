Instance: ex-Bundle-pandemicIPS-example-patient-1-stage-0
...
* entry[+].fullUrl = "http://example.org/Composition/ex-Composition-pandemicIPS-stage-0"
* entry[=].resource = ex-Composition-pandemicIPS-stage-0
* entry[=].id = "ex-Composition-pandemicIPS-stage-0"
* entry[+].fullUrl = "http://example.org/Patient/ex-Patient-pandemicIPS-stage-0"
* entry[=].resource = ex-Patient-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Organization/ex-Organization-pandemicIPS-stage-0"
* entry[=].resource = ex-Organization-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-0"
* entry[=].resource = ex-Practitioner-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-0"
* entry[=].resource = ex-Practitioner2-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/MedicationStatement/ex-MedicationStatement-pandemicIPS-stage-0"
* entry[=].resource = ex-MedicationStatement-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition1-pandemicIPS-stage-0"
* entry[=].resource = ex-Condition1-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition2-pandemicIPS-stage-0"
* entry[=].resource = ex-Condition2-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Condition/ex-Condition3-pandemicIPS-stage-0"
* entry[=].resource = ex-Condition3-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Procedure/ex-Procedure-pandemicIPS-stage-0"
* entry[=].resource = ex-Procedure-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/AllergyIntolerance/ex-Allergy-pandemicIPS-stage-0"
* entry[=].resource = ex-Allergy-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-Lab-pandemicIPS-stage-0"
* entry[=].resource = ex-Lab-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Immunization/ex-Immunization-pandemicIPS-stage-0"
* entry[=].resource = ex-Immunization-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-PastPresJob-pandemicIPS-stage-0"
* entry[=].resource = ex-PastPresJob-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-PregStat-pandemicIPS-stage-0"
* entry[=].resource = ex-PregStat-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-EDD-pandemicIPS-stage-0"
* entry[=].resource = ex-EDD-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/DeviceUseStatement/ex-DeviceUse-pandemicIPS-stage-0"
* entry[=].resource = ex-DeviceUse-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Device/ex-Device-pandemicIPS-stage-0"
* entry[=].resource = ex-Device-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/CarePlan/ex-CarePlan-pandemicIPS-stage-0"
* entry[=].resource = ex-CarePlan-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Flag/ex-Alert-pandemicIPS-stage-0"
* entry[=].resource = ex-Alert-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/ClinicalImpression/ex-ClinicalImp-pandemicIPS-stage-0"
* entry[=].resource = ex-ClinicalImp-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSignsPanel-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSignsPanel-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-Height-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSigns-Height-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-Weight-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSigns-Weight-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-BMI-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSigns-BMI-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-BP-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSigns-BP-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-HeartRate-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSigns-HeartRate-pandemicIPS-stage-0
* entry[+].fullUrl = "http://example.org/Observation/ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-0"
* entry[=].resource = ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-0


Instance: ex-Composition-pandemicIPS-stage-0
InstanceOf: IHE_IPS_Complete_Option_Composition
Description: """
This example composition represents the IPS Composition Structure that expresses the implementation of the Complete Option for IPS, where all optional sections are now Must Support sections. This composition is part of the original record provided by the health data holder for the pandemic patient.
This composition acts as the stage (0), origional document, where there have been no alterations to the information. This acts as the original document to the Stage 1 and 2 Bunde examples that implement the different stages of de-Identification.
"""
Usage: #example
...
* id = "ex-Composition-pandemicIPS-stage-0"
* status = #final
* type = $loinc#60591-5
* subject = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-0)
* date = "2024-07-01T00:00:00Z"
* author = Reference(http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-0)
* title = "International Patient Summary"
* confidentiality = #N
* custodian = Reference(http://example.org/Organization/ex-Organization-pandemicIPS-stage-0)
...
* section[sectionMedications].entry[+] = Reference(http://example.org/MedicationStatement/ex-MedicationStatement-pandemicIPS-stage-0)
...
* section[sectionAllergies].entry[+] = Reference(http://example.org/AllergyIntolerance/ex-Allergy-pandemicIPS-stage-0)
...
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition1-pandemicIPS-stage-0)
* section[sectionProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition2-pandemicIPS-stage-0)
...
* section[sectionPastProblems].entry[+] = Reference(http://example.org/Condition/ex-Condition3-pandemicIPS-stage-0)
...
* section[sectionImmunizations].entry[+] = Reference(http://example.org/Immunization/ex-Immunization-pandemicIPS-stage-0)
...
* section[sectionProceduresHx].entry[+] = Reference(http://example.org/Procedure/ex-Procedure-pandemicIPS-stage-0)
...
* section[sectionResults].entry[+] = Reference(http://example.org/Observation/ex-Lab-pandemicIPS-stage-0)
...
* section[sectionSocialHistory].entry[+] = Reference(http://example.org/Observation/ex-PastPresJob-pandemicIPS-stage-0)
...
* section[sectionPregnancyHx].entry[+] = Reference(http://example.org/Observation/ex-PregStat-pandemicIPS-stage-0)
...
* section[sectionMedicalDevices].entry[+] = Reference(http://example.org/DeviceUseStatement/ex-DeviceUse-pandemicIPS-stage-0)
...
* section[sectionVitalSigns].entry[+] = Reference(http://example.org/Observation/ex-VitalSignsPanel-pandemicIPS-stage-0)
...
* section[sectionPlanOfCare].entry[+] = Reference(http://example.org/CarePlan/ex-CarePlan-pandemicIPS-stage-0)
...
* section[sectionAlerts].entry[+] = Reference(http://example.org/Flag/ex-Alert-pandemicIPS-stage-0)
...
* section[sectionFunctionalStatus].entry[+] = Reference(http://example.org/ClinicalImpression/ex-ClinicalImp-pandemicIPS-stage-0)

Instance: ex-Organization-pandemicIPS-stage-0
InstanceOf: OrganizationUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Organization-uv-ips"
* id = "ex-Organization-pandemicIPS-stage-0"
...
Instance: ex-Patient-pandemicIPS-stage-0
...
"""
Usage: #example
* id = "ex-Patient-pandemicIPS-stage-0"
...
* generalPractitioner = Reference(http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-0) "Yaser, Joseph"
...
Instance: ex-Practitioner2-pandemicIPS-stage-0
InstanceOf: PractitionerUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Practitioner-uv-ips"
* id = "ex-Practitioner2-pandemicIPS-stage-0"
* name.text = "Joseph Yaser"
* name.family = "Joseph"
* name.given = "Yaser"

Instance: ex-MedicationStatement-pandemicIPS-stage-0
InstanceOf: MedicationStatementIPS
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationStatement-uv-ips"
* id = "ex-MedicationStatement-pandemicIPS-stage-0"
* status = #completed
...
* asserter = Reference(http://example.org/Practitioner/ex-Practitioner2-pandemicIPS-stage-0)

Instance: ex-Condition2-pandemicIPS-stage-0
InstanceOf: ConditionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Condition-uv-ips"
* id = "ex-Condition2-pandemicIPS-stage-0"
* clinicalStatus = $condition-clinical#active
* verificationStatus = $condition-ver-status#confirmed
* category = $condition-category#problem-list-item "Problem List Item"
* severity = $sct#24484000 "Severe"
...
Instance: ex-Condition3-pandemicIPS-stage-0
InstanceOf: ConditionUvIps
Usage: #inline
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Condition-uv-ips"
* id = "ex-Condition3-pandemicIPS-stage-0"
...
* patient = Reference(http://example.org/Patient/ex-Patient-pandemicIPS-stage-0)
* onsetDateTime = "2020-10-01"
* lastOccurrence = "2020-10-01"
* reaction.manifestation = $sct#271807003 "Rash"
* reaction.severity = #moderate

Instance: ex-Lab-pandemicIPS-stage-0
...
Instance: ex-PregStat-pandemicIPS-stage-0
...
* id = "ex-PregStat-pandemicIPS-stage-0"
* status = #final
...
* hasMember = Reference(http://example.org/Observation/ex-EDD-pandemicIPS-stage-0)

Instance: ex-EDD-pandemicIPS-stage-0
...
Instance: ex-Alert-pandemicIPS-stage-0
...
* id = "ex-Alert-pandemicIPS-stage-0"
...
* performer = Reference(http://example.org/Practitioner/ex-Practitioner-pandemicIPS-stage-0)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-Height-pandemicIPS-stage-0)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-Weight-pandemicIPS-stage-0)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-BMI-pandemicIPS-stage-0)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-BP-pandemicIPS-stage-0)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-HeartRate-pandemicIPS-stage-0)
* hasMember[+] = Reference(http://example.org/Observation/ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-0)

Instance: ex-VitalSigns-Height-pandemicIPS-stage-0
InstanceOf: vitalsigns 
Usage: #inline
* meta.profile = "http://hl7.org/fhir/StructureDefinition/vitalsigns"
* id = "ex-VitalSigns-Height-pandemicIPS-stage-0"
* status = http://hl7.org/fhir/observation-status#final
...
Instance: ex-VitalSigns-Weight-pandemicIPS-stage-0
InstanceOf: vitalsigns
Usage: #inline
* meta.profile = "http://hl7.org/fhir/StructureDefinition/vitalsigns"
* id = "ex-VitalSigns-Weight-pandemicIPS-stage-0"
* status = http://hl7.org/fhir/observation-status#final
...
Instance: ex-VitalSigns-BMI-pandemicIPS-stage-0
InstanceOf: vitalsigns
Usage: #inline
* meta.profile = "http://hl7.org/fhir/StructureDefinition/vitalsigns"
* id = "ex-VitalSigns-BMI-pandemicIPS-stage-0"
* status = http://hl7.org/fhir/observation-status#final
...
Instance: ex-VitalSigns-BP-pandemicIPS-stage-0
InstanceOf: vitalsigns
Usage: #inline
* meta.profile = "http://hl7.org/fhir/StructureDefinition/vitalsigns"
* id = "ex-VitalSigns-BP-pandemicIPS-stage-0"
* status = http://hl7.org/fhir/observation-status#final
...
Instance: ex-VitalSigns-HeartRate-pandemicIPS-stage-0
InstanceOf: vitalsigns
Usage: #inline
* meta.profile = "http://hl7.org/fhir/StructureDefinition/vitalsigns"
* id = "ex-VitalSigns-HeartRate-pandemicIPS-stage-0"
* status = http://hl7.org/fhir/observation-status#final
...
Instance: ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-0
InstanceOf: vitalsigns
Usage: #inline
* meta.profile = "http://hl7.org/fhir/StructureDefinition/vitalsigns"
* id = "ex-VitalSigns-OxygenSaturation-pandemicIPS-stage-0"
* status = http://hl7.org/fhir/observation-status#final
