...
Instance: ex-ips-io-carePlan-birthPlan-jannet-guo
InstanceOf: CarePlan
...
* subject = Reference(Patient/ex-patient-jannet-guo) "Jannet Guo"
...
* participant[0].actor = Reference(Patient/ex-patient-jannet-guo) "Jannet Guo"
